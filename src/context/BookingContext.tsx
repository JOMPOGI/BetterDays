...
export type PackageType = 'wedding' | 'prenup' | 'wedding_photo' | 'prenup_photo' | null;
...
export function BookingProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <BookingContext.Provider value={{
      state, setPackage, setDate, setQuotation, setClientDetails, setPaymentReference, resetBooking
    }}>
      {children}
